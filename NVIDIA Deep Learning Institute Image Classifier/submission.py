...
def deploy(img_path):
    ...
    net = caffe.Classifier('/dli/data/digits/20190617-233445-04a1/deploy.prototxt', '/dli/data/digits/20190617-233445-04a1/snapshot_iter_108.caffemodel',
                           channel_swap=(2,1,0),
                           raw_scale=255,
                           image_dims=(256, 256))
    ...
    mean_image = caffe.io.load_image('/dli/data/digits/20190617-233445-04a1')
